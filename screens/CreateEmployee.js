...
const CreateEmployee =({navigation,route})=>{
    ...
    const submitData = ()=>{
        fetch("http://0a6abcac.ngrok.io/send-data",{
            method:"post",
            headers:{
    ...
    const updateDetails =()=>{
        fetch("http://0a6abcac.ngrok.io/update",{
            method:"post",
            headers:{
                'Content-Type': 'application/json'
            },
    ...
    const handleUpload = (image)=>{
        ...
        data.append("cloud_name","Employeeapp")


        fetch("https://api.cloudinary.com/v1_1/employeeapp/image/upload",{
            method:"post",
            body:data
        }).then(res=>res.json()).
        then(data=>{
